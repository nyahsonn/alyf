...
class UploadTooLarge(ValueError):
    """The PDF is over what Document AI will accept in one request -- in bytes
    or in pages.
...
async def text_from_upload(raw: bytes) -> tuple[str, str]:
    ...
    from app.ingestion.ocr import FileTooLarge, OcrError, TooManyPages, extract_bytes
    ...
    except (FileTooLarge, TooManyPages) as e:
        # Before OcrError, which both subclass.
